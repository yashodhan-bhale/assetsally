...
class ApiClient {
    ...
    getLocation(id: string) { return this.request(`/locations/${id}`); }
    ...
    getInventoryItem(id: string) { return this.request(`/inventory/${id}`); }
    ...
    getAuditReport(id: string) { return this.request(`/audits/${id}`); }
    reviewReport(id: string, action: string, notes?: string) {
        return this.request(`/audits/${id}/review`, { method: 'POST', body: { action, reviewNotes: notes } });
    }
    ...
    generateQrBatch(count: number, prefix?: string) {
        return this.request('/qr-tags/generate', { method: 'POST', body: { count, prefix } });
    }
    assignQrTag(code: string, itemId: string) {
        return this.request(`/qr-tags/${code}/assign`, { method: 'POST', body: { itemId } });
    }
