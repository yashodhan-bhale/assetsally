...
import { FileCheck, Search, ChevronLeft, ChevronRight, Clock, CheckCircle2, XCircle, AlertCircle } from 'lucide-react';
...
export default function AuditsPage() {
    ...
    const { data, isLoading } = useQuery({
        ...
        queryFn: () => api.getAudits({ status: status || undefined, page: String(page), limit: '20' } as any),
    });
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-slate-400 text-sm mt-1">View and review verification audit reports</p>
            </div>
                                ...
                                <div className="flex items-start justify-between mb-3">
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 mt-0.5">
                                            Auditor: {report.auditor?.name} — {new Date(report.createdAt).toLocaleDateString()}
                                        </p>
                                    </div>
