    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.scannerArea}>
                ...
                <Text style={styles.scanHint}>Point camera at QR tag or enter code manually</Text>
            </View>
                    ...
                    {result.linkedItem && (
                        <>
                            ...
                            <View style={styles.resultRow}>
                                ...
                                <Text style={styles.resultValue}>{result.linkedItem.location?.name || '—'}</Text>
                            </View>
                        </>
                    )}
                </View>
...
const styles = StyleSheet.create({
    ...
    sectionLabel: { color: '#94a3b8', fontSize: 12, fontWeight: '600', marginBottom: 8, textTransform: 'uppercase' },
    ...
    lookupBtn: {
        backgroundColor: '#3b82f6', paddingHorizontal: 16, borderRadius: 12,
