...
export default function AuditsTab() {
    ...
    useFocusEffect(useCallback(() => { loadAudits(); }, [loadAudits]));
        ...
        return (
            ...
            >
                <View style={styles.cardHeader}>
                    <View style={{ flex: 1 }}>
                        <Text style={styles.cardTitle}>{item.location?.name || 'Unknown Location'}</Text>
                ...
                <View style={styles.cardFooter}>
                    ...
                    <Text style={styles.findingsCount}>{item._count?.findings || 0} findings</Text>
                </View>
            </TouchableOpacity>
        );
    };
